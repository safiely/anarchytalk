 ...
 *
 * @author Paul Smith
 * @see ao.protocol.packets.CharacterListPacket
 * @see ao.protocol.packets.LoginOkPacket
 * @see ao.protocol.packets.LoginRequestPacket
 * @see ao.protocol.packets.LoginSelectPacket
 */
