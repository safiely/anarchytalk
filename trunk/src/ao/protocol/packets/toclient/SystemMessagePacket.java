...
public class SystemMessagePacket extends Packet {
     ...
     * @param file
     *        Location of the mdb for extended messages, will be changed soon
     */
    public SystemMessagePacket(int clientID, int windowID, int messageID, String msg, String file){
        m_clientID = clientID;
        m_windowID = windowID;
        m_messageID = messageID;
        m_msg = msg;
        m_ex_msg = new ExtendedMessage(cat_id, m_messageID, m_msg, file);
     ...
     * @param file
     *        location of where the mdb file can be found for extended messages
     ...
     */
    public SystemMessagePacket(byte[] data, String file) throws MalformedPacketException {
