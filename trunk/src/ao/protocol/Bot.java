...
/**
 * AOBot specifies the basic structure of a bot.
 * All bot implentations should implement the AOBot interface.
 *
 * @author Paul Smith
 * @see ao.protocol.simple.AOSimpleBot
 * @see ao.protocol.packets.utils.AOPacketFactory
 * @see ao.modules.AOModule
 * @see ao.modules.AOModuleList
 * @see ao.modules.AOBotCommand
 */
