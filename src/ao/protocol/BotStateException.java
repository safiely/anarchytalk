 ...
 * while in the incorrect state for that opperation.</p>
 *
...
public class BotStateException extends RuntimeException {
    ...
    private final Bot.State m_currentState, m_requiredState;
     ...
     */
    public BotStateException(String message, Bot.State currentState, Bot.State requiredState) {
        super(message);
    ...
    public Bot.State getCurrentState() { return m_currentState; }
    /** Returns the state that the bot should have been in at the time this exception was thrown. */
    public Bot.State getRequiredState() { return m_requiredState; }
