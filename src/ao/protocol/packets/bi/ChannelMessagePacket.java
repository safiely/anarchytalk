 ...
 *
 * @author Paul Smith
 * @see ChannelUpdatePacket
 *
 * @see PrivateMessagePacket
 * @see VicinityMessagePacket
 * @see AnonVicinityMessagePacket
...
public class ChannelMessagePacket extends MessagePacket {
     ...
     */
    public ChannelMessagePacket(byte[] data, Direction d, String file) throws MalformedPacketException {
        ...
        try {
            ...
            if(m_characterID == 0 && m_msg.startsWith("~&") && m_msg.endsWith("~")){
                ...
                m_ex_msg = new ExtendedMessage(new DataInputStream(new ByteArrayInputStream(e_msg.getBytes("UTF-8"))), file);
            } else {
                m_ex_msg = null;
            }
