...
public class PacketSerializer {
     ...
     * @see #write(short)
     * @see #write(int)
     * @see AOPacketParser#parseIntArray()
     */
    public void write(int[] data) {
        try { 
     ...
     * @see #write(short)
     * @see #write(String)
     * @see AOPacketParser#parseStringArray()
     */
    public void write(String[] data) {
        try { 
            m_output.writeShort( data.length );
